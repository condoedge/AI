 ...
 *   new AiChatFloating(null, ['position' => 'bottom-left'])
 */
class AiChatFloating extends Form
{
    ...
    public function render()
    {
        ...
        return _Rows(
            $this->pulse ? _Html('')->class('absolute inset-0 rounded-full bg-indigo-500 animate-ping opacity-25') : null,
            _Link(...$content)
