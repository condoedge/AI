...
The AI wrapper (`Condoedge\Ai\Wrappers\AI`) has been refactored to follow Laravel best practices. The old wrapper used anti-patterns (Service Locator, Static Singleton) that made testing difficult and bypassed Laravel's container.
...
**Simple Migration:** Change `use Condoedge\Ai\Wrappers\AI;` to `use Condoedge\Ai\Facades\AI;`
