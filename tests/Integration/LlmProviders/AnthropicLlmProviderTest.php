...
/**
 * Integration Tests for AnthropicLlmProvider
 *
 * These tests make actual API calls to Anthropic.
 ...
 * vendor/bin/phpunit tests/Integration/LlmProviders/AnthropicLlmProviderTest.php
 */
class AnthropicLlmProviderTest extends TestCase
{
    private ?AnthropicLlmProvider $provider = null;
    ...
    protected function setUp(): void
    {
        ...
        if (!$apiKey || $apiKey === 'your-anthropic-api-key-here') {
            $this->markTestSkipped('Anthropic API key not configured. Set ANTHROPIC_API_KEY environment variable to run integration tests.');
        }
    ...
    public function test_handles_api_error_for_invalid_key()
    {
        $provider = new AnthropicLlmProvider([
            'api_key' => 'sk-ant-invalid-key-test',
            'model' => 'claude-3-5-sonnet-20241022',
        ]);
    ...
    public function test_chat_with_system_message_in_messages_array()
    {
        $messages = [
